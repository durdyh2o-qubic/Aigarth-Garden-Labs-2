...
- **Real-time Throughput**: ~14.1M IT/s peak / ~6.3M IT/s average
...
The garden utilizes `garden_automation.py` for autonomous parsing and reporting. Results are synthesized daily into the Hermes Second Brain for long-term emergence tracking.
